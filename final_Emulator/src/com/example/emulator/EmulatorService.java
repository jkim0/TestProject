...
public class EmulatorService extends Service {
	...
	private BroadcastReceiver mReceiver = new BroadcastReceiver() {
		...
		public void onReceive(Context context, Intent intent) {
			...
			//PowerManager pmb = (PowerManager) getSystemService(Context.POWER_SERVICE);
	///WIFI	
		...
		public void onCommandReceived(String cmd, String value) {
			...
			if (cmd.equalsIgnoreCase("screen")) {
				...
				if (value.equalsIgnoreCase("on")) {
					...
					keyEvent(theKeyBoard.get("KEYCODE_POWER").toString());
					//screen on
...
//		PowerManager pmc = (PowerManager) getSystemService(Context.POWER_SERVICE);
//		if(pmc.isScreenOn())
//		{
//			info.screen = "ON";
//		}
