...
public class MainActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		Service_exit = (Button)findViewById(R.id.Change_Mode);
		...
		Service_exit.setOnClickListener(new View.OnClickListener() {
