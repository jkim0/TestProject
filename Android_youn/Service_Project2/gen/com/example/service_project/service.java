...
@Override public void Unregister(com.example.service_project.CountingListener register) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
static final int TRANSACTION_Broadcast_Mode = (android.os.IBinder.FIRST_CALL_TRANSACTION + 4);
static final int TRANSACTION_Listener_Mode = (android.os.IBinder.FIRST_CALL_TRANSACTION + 5);
...
public void Unregister(com.example.service_project.CountingListener register) throws android.os.RemoteException;
